...
namespace CoreTestApp.Controllers
{
    public class WidgetsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WidgetID,Name,RandomNumber")] Widget widget)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WidgetID,Name,RandomNumber")] Widget widget)
        {
